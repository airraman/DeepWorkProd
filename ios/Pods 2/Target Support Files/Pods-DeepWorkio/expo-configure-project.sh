...
with_node \
  ...
  --target "/Users/Raman/Desktop/Development/personal/sstech/DeepWorkProd/ios/Pods/Target Support Files/Pods-DeepWorkio/ExpoModulesProvider.swift" \
  --entitlement "/Users/Raman/Desktop/Development/personal/sstech/DeepWorkProd/ios/DeepWorkio/DeepWorkio.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-av" "expo-background-fetch" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-eas-client" "expo-file-system" "expo-font" "expo-keep-awake" "expo-notifications" "expo-sqlite" "expo-updates"
